...
public class cards {
	...
	private Special cardSpecial;
	private boolean visibility;

	public cards(Ranks initRank, Suites initSuite, Special initcardSpecial) {
		cardRank = initRank;
		cardSuite = initSuite;
	 ...
	 */
	public void setSepcial(Special newSpecial) {
	...
	public static void main(String[] args) {
		cards testCard = new cards(Ranks.Two, Suites.Spades, Special.Bomb);
